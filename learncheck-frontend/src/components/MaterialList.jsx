import { BookOpen, Calendar, Download, FileText, PlayCircle } from "lucide-react";
...
export default function MaterialList({ subject }) {
  ...
  useEffect(() => {
    // Load materials from localStorage (demo)
  ...
  if (materials.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
        ...
        <p className="text-gray-500 text-lg font-medium">Belum ada materi tersedia</p>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-4xl">{getFileIcon(material.fileName)}</span>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-2 text-xs text-gray-400 mb-4">
                ...
                <span>Upload: {formatDate(material.uploadDate)}</span>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => handleStartQuiz(material.subject)}
